...
from config.TRADING_CONFIG import API_KEY, SECRET_KEY, COIN_1_SYMBOL, COIN_1_ROL_DAY, COIN_1_LONG_THRES


class Strat_1_TradingService:
    # const
    symbol: str = COIN_1_SYMBOL + 'USDT'
    symbol_ds: str = COIN_1_SYMBOL + '/USDT'
    rol_day: float = COIN_1_ROL_DAY
    long_thres: float = COIN_1_LONG_THRES
